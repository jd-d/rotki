...
declare module 'vue-router/auto-routes' {
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/settings.vue': {
      routes: '/settings' | '/settings/accounting/' | '/settings/general/' | '/settings/database/' | '/settings/interface/' | '/settings/account/' | '/settings/modules/' | '/settings/oracle/' | '/settings/rpc/' | '/settings/account' | '/settings/accounting' | '/settings/database' | '/settings/general' | '/settings/interface' | '/settings/modules' | '/settings/oracle' | '/settings/rpc'
      views: 'default'
    }
